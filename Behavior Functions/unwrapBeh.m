...
finalData = zeros(size(rawData)); % Initializing finalData
lapCrossings = zeros(size(rawData)); % Initializing lapCrossings
flagMatrix = zeros(size(rawData)); % Initializing flagMatrix
